...
import AgentForm from '@/components/ContactUs/Hero/RightSide/AgentForm';
...
const RightSide = () => {
    return (
        <div className=' w-full relative h-full md:min-h-[650px] min-h-[500px] overflow-hidden flex items-center justify-center'>
            ...
            {/* Card Content */}
            <div className='relative z-10 w-full max-w-[650px] mx-auto px-5 md:px-0'>
                <div className=' rounded-[20px]  relative overflow-hidden md:mt-16 mt-8'>
                    ...
                    <div className='relative z-10 px-5 md:px-0'>
                        ...
                        {/* Description */}
                        <Text className='text-[#050000] text-[16px] md:text-[18px] font-normal font-mona-sans mb-6 text-center leading-relaxed px-0 md:px-8'>
                        ...
                        {/* Sub-text */}
                        <Text className='text-[#050000] text-[16px] font-normal font-mona-sans mt-4 text-center'>
