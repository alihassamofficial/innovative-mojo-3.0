...
const Technical = () => {
  return (
    <div>
      ...
      <Text className="text-black md:text-[22px] leading-[32px] w-full max-w-[1014px] mb-[85px] text-center mx-auto">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-4 md:px-8 pt-8 md:pt-16 pb-16 md:pb-24">
          <div className="flex gap-8 md:flex-row flex-col md:justify-start justify-center items-center">
            ...
            <div className="rounded-lg border border-[#FFFFFF] w-full md:max-w-[351px] max-w-full px-[37px] py-10">
              ...
              <Text className="text-white text-[16px] md:text-[22px] leading-[24px] md:leading-[28px] font-normal font-mona-sans">
                Lead Nurturing: If a caller isn't ready to buy today, the AI
                tags them for a long-term drip campaign so you stay top-of-mind
                automatically.
              </Text>
            </div>
          </div>
