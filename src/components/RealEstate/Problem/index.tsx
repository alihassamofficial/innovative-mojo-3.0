  ...
  return (
    <>
      <div className="relative w-full bg-white md:h-[424px] mt-[85px] mb-[-50px] md:mb-[233px] px-5">
        <Text
          as="h2"
          className="text-black md:text-[48px] font-bold leading-[54px] font-mona-sans capitalize mb-[31px] md:mb-[75px] text-center mx-auto"
      ...
      <div className="relative w-full bg-white py-20 md:py-[84px] overflow-hidden md:min-h-[516px] flex items-center justify-center">
        {/* Background */}
