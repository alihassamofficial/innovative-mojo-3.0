...
const TheSolution = () => {
  const solutions = [
    ...
    },
    {
      ...
      description: (
        <>
          <div className="text-[14px] leading-[22px] font-normal font-mona-sans">
            We train the AI on your specific acceptance criteria. It asks the
            critical questions so you don&apos;t have to.
          </div>
          <ul className="list-disc pl-5 text-[14px] leading-[22px] font-normal font-mona-sans">
            <li className="text-black">
              ...
              (Statute of limitations check). &quot;Was there a police report
              filed?&quot;
            </li>
            <li className="text-black">
              Family Law: &quot;Are there minor children involved?&quot;
    ...
    <section className="relative w-full bg-white mb-[92px]  overflow-hidden">
      <div className="max-w-[1240px] mx-auto px-5">
        <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
          <Text
            as="h1"
            className="text-center md:text-[48px] md:leading-[60px] font-bold font-mona-sans mb-[12px] "
          >
            The Solution: The AI Intake Specialist
          </Text>
        </div>
        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
          <Text className="text-center max-w-[740px] mx-auto mb-12">
            We deploy HIPAA-compliant, secure voice agents that act as your
            firm&apos;s first line of defense. This is not a &quot;call
            center.&quot; This is a custom-trained logic engine.
          </Text>
        </div>
